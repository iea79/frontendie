...
<section id="homeScreen" class="homeScreen section">
    <div class="homeScreen__bg" id="homeBg">
        <?php echo wp_get_attachment_image(SCF::get('first__bg'), 'full', false, array("fetchpriority" => "high", "class" => "mobile"))
        ?>
        <video class="desktop" id="video" src="<?php echo get_template_directory_uri() . '/video/fbg.mp4' ?>" autoplay muted loop></video>
        <script>
    ...
    <div class="homeScreen__content">
        <div class="container_center">
            <div class="homeScreen__title">
                <h1><?php echo SCF::get('first__title'); ?></h1>
            </div>
