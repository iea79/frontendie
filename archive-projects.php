		...
		<div class="homeScreen__content">
			<div class="container_center">
				...
				<div class="homeScreen__sub">
					<p>На странице собраны работы за последние годы из тех, что могу размещать в портфолио</p>
					<p>Подавляюшая часть проектов сделаны мной, в паре участвовали мои студенты</p>
				</div>
			</div>
		</div>
	</section>
